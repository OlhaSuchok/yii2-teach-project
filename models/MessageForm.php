...
<!-- Просто копія пройденого матеріалу з TestForm -->
<?php
...
{
    // Створюємо властивості форми. Якщо наслідуємо від класу Model, то вони необхідні, а якщо від ActiveRecord, то yii створить їх замість нас
    // public $name;
    // public $email;
    // public $text;
