...
<!--Віджети -------------------------------------------------------------------->
<?php 
// Передача параметрів у віджет
// echo MyWidget::widget(['name' => 'Дмитро:)']);
// У випадку не передаі параметрів у віджет, будуть застосовані по дефолту, які визначені у методі init 
